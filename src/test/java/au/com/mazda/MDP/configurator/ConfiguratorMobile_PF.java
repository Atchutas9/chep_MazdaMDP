...
/**
 * The Class ConfiguratorMobile_PF.
 */
public class ConfiguratorMobile_PF extends SuperClass {

    /**
     * Instantiates a new configurator mobile PF.
     *
     * @param driver
     *            the driver
     */
    public ConfiguratorMobile_PF(WebDriver driver) {
    ...
    @FindBy(how = How.CSS, using = "a[data-test='flex-title']")
